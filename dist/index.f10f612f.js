...
})({"6UdNG":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "612f3d76f10f612f";
"use strict";
...
},{}],"1rsVK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _core = require("@mojs/core");
var _coreDefault = parcelHelpers.interopDefault(_core);
var _switch = require("./switch");
var _switchDefault = parcelHelpers.interopDefault(_switch);
const spark = new _coreDefault.default.Burst({
    left: 0,
    top: 0,
    count: 20,
    radius: {
    ...
    children: {
        ...
        duration: 3000,
        easing: _coreDefault.default.easing.bezier(0.1, 1, 0.3, 1)
    }
});
const dots = new _coreDefault.default.Burst({
    left: 0,
    top: 0,
    count: 20,
    radius: {
...
const sun = new _coreDefault.default.Shape({
    left: 0,
    top: 0,
    count: 1,
    radius: {
...
const moon = new _coreDefault.default.Shape({
    left: 0,
    top: 0,
    count: 1,
    radius: {
...
_switchDefault.default.addEventListener("click", function(e) {
    /*  spark.tune({ x: e.pageX, y: e.pageY }).replay();
  dots.tune({ x: e.pageX, y: e.pageY }).replay();
  sun.tune({ x: e.pageX, y: e.pageY }).replay(); */ moon.tune({
        x: e.pageX,
        y: e.pageY
    }).replay();
});

},{"@mojs/core":"kBnDU","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","./switch":"6N3eq"}],"kBnDU":[function(require,module,exports) {
/*!
...
},{}],"6N3eq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["6UdNG","1rsVK"], "1rsVK", "parcelRequire0c67")

//# sourceMappingURL=index.f10f612f.js.map
